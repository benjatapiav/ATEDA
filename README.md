...
- Como referencia para la organización de los datos se usaron los siguientes documentos y sitios web.
  1. Bases Curriculares 1° - 6° básico
  2. Bases Curriculares 7° - II medio
  3. Bases Curriculares III medio - IV medio
  4. Diseño Universal del Aprendizaje (DUA)
  5. Centro de Estudios Mineduc (CEM)
  6. Mapa de Justicia Educacional (https://www.mapadejusticiaeducacional.cl/)

Con estas herramientas fué posible delimitar los parámetros de las fuentes de información correctas, que tipo de data necesito para crear los indicadores. 
